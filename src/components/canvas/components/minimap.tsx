...
export default function Minimap({
  ...
  return (
    <div
      // Marks this corner for the editor's onboarding walkthrough to reveal.
      // Inert markup — the canvas still knows nothing about the app around it.
      data-tour="minimap"
      className="absolute left-0 bottom-0 w-44 rounded-tr-lg bg-sidebar p-2 border-t border-r border-border shadow-chrome"
    >
